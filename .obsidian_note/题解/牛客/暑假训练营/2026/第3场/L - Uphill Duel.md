...
（在一些单向并查集删除，二维矩阵覆盖等中经常用到该思想）
## 题目大意：

![](Pasted%20image%2020260730154436.png)
...
1. 每个节点的可以走的路径方向取决于该点四周比当前节点更大的路径方向；
	
2. 现在知道了当前节点取决于该店四周更高节点的状态，也就是说前序节点状态由后序节点状态确定，对应一个逆向过程，这里就是我们逆向思想的标志了；
